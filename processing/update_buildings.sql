...
INSERT INTO rak(xyind, rakv, rakyht_ala, asuin_ala, erpien_ala, rivita_ala, askert_ala, liike_ala, myymal_ala, majoit_ala, asla_ala, ravint_ala, tsto_ala, liiken_ala, hoito_ala, kokoon_ala, opetus_ala, teoll_ala, varast_ala, muut_ala, teoll_lkm, varast_lkm)
SELECT
    ...
    ((teoll_osuus * k_muu_ala) / teoll_koko)::int, -- teoll_lkm
    ((varast_osuus * k_muu_ala) / varast_koko)::int -- varast_lkm
FROM ykr;
