...
NULL::int AS teoll_lkm,
NULL::int AS varast_lkm 
FROM rak r
LEFT JOIN 
(WITH
...
UPDATE rak_temp set rakyht_ala = past.rakyht_ala,
	...
	varast_ala = past.varast_ala, muut_ala = past.muut_ala, teoll_lkm = past.teoll_lkm, varast_lkm = past.varast_lkm
